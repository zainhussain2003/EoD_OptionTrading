#!/usr/bin/env python3
"""
BACKTEST FRIDAY ONLY  —  scoring method: MAX RELIABILITY  (win_rate only)

Same as backtest_byday_winrate.py, but looks at FRIDAY expiries only (0DTE —
the option expires the same day). Finds each equity's most consistently-winning
Friday entry/exit time, shows per-day P&L, all heatmaps, and a per-equity +
combined summary.
