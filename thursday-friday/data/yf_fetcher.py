...
from utils.math_utils import (
    black_scholes_call, calc_pop, calc_theta_hourly, realized_vol
)
...
class YFinanceFetcher:
    ...
    def fetch_option_chain(self, ticker: str, expiry_date: date,
        ...
        """Fetch call option chain via yfinance. Greeks computed via Black-Scholes."""
        contracts = []
        ...
        for _, row in df.iterrows():
            try:
                ...
                _, delta, _, _ = black_scholes_call(spot, strike, T, risk_free_rate, iv)
