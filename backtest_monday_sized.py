#!/usr/bin/env python3
"""
BACKTEST MONDAY ONLY  —  TARGET-SPEND POSITION SIZING

Identical to backtest_friday_sized.py (max-expected-profit scoring with
target-spend position sizing) with ONE change: it looks at MONDAY 0DTE expiries
only (the option expires the same day). Instead of always buying exactly 1
contract, it buys enough contracts to spend a minimum target amount per trade.
