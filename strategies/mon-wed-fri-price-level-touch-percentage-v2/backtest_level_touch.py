...
R × (1 ± pct), at any point between 9:30 AM and 4:00 PM ET?
  ...
  v2: TSLA + AAPL only, on an 11-level ladder — ±0.5%, 0.75%, 1%, 1.25%, 1.5%,
  2%, 2.5%, 3%, 3.5%, 4%, 5% (edit config.py) — so the touch rate reads as a
  curve, not five points.
...
if __name__ == "__main__":
    run_level_touch(
        ...
        header_extra=(
            ...
            f"each per-ticker percentage on the 11-level ladder (0.5% → 5%), for "
            f"Mon/Wed/Fri. "
