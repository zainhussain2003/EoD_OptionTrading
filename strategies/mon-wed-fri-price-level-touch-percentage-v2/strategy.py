...
def build_metrics(all_results, config, source_label):
    ...
    return {
        "status": "ok",
        "strategy": "mon-wed-fri-price-level-touch-percentage-v2",
        "tickers": tickers,
    ...
    try:
        ...
        all_results = le.run_level_touch(
            ...
            header_extra=(
                ...
                "across the 11-level ladder (0.5% → 5%), for Mon/Wed/Fri; swings "
                "shown as % of reference ($ in brackets)."
            ),
        )
        ...
        metrics = {"status": "error", "strategy": "mon-wed-fri-price-level-touch-percentage-v2",
