#!/usr/bin/env python3
"""
THURSDAY INTRADAY — OPTIMAL ENTRY/EXIT TIME-FRAME ANALYSIS  (target-spend sized)

Finds the best *time frame* to ENTER and the best *time frame* to EXIT an AAPL or
TSLA option over the whole regular session (9:30 AM–4:00 PM ET), on THURSDAYS only,
trading the FRIDAY-expiry weekly intraday (1DTE — bought and sold the same
Thursday), for BOTH calls and puts.
