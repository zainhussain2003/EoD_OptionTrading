...
@dataclass
class Config:
    # Friday INTRADAY (0DTE) non-overlapping call+put pairing across a basket of
    # large-cap names — per equity a call window and a put window that never hold
    # at the same time (concentration-capped pass 2 also computed).
