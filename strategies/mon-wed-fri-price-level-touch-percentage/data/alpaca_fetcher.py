...
class AlpacaFetcher:
    ...
    def from_env(cls) -> 'AlpacaFetcher | None':
        ...
        # Canonical name used by the pipeline / CLAUDE.md is ALPACA_SECRET_KEY;
        # fall back to the legacy ALPACA_API_SECRET used by calls/.env.
    ...
    def fetch_option_chain(self, ticker: str, expiry_date: date,
        ...
        """Fetch live call option chain with greeks."""
        contracts = []
        try:
