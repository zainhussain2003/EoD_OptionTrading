#!/usr/bin/env python3
"""
BACKTEST BY DAY  —  scoring method: MAX RELIABILITY  (win_rate only)

Finds the most consistently-winning entry/exit time separately for Monday,
Wednesday, and Friday. At the bottom shows a combo table so you can compare
trading all 3 days vs only the best day(s).
...
# ──────────────────────────────────────────────────────────────────────────
# Engine below. Run with:   python backtest_byday_winrate.py
# ──────────────────────────────────────────────────────────────────────────
