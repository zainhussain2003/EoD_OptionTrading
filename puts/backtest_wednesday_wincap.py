#!/usr/bin/env python3
"""
BACKTEST WEDNESDAY ONLY  —  TARGET-SPEND SIZING  +  WIN-RATE CAP

Same engine as backtest_wednesday_sized.py (Wednesday 0DTE, max-expected-profit
...
LOOKBACK_DAYS = 140          # <───── window to test (calendar days)
...
# ──────────────────────────────────────────────────────────────────────────
# Engine below. Run with:   python backtest_wednesday_wincap.py
# ──────────────────────────────────────────────────────────────────────────
import math
